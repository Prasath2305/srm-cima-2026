...
// //               <p className="text-sm text-black mt-1">Secure transaction details</p>
// //             </div>
...
// //                         <p className="text-xs text-black mt-1">JPG or PNG (Max 5MB)</p>
// //                       </>
// //                     )}
// //                   </div>
// //                 </div>
...
// //               <p className="text-sm text-black mt-1">Please verify all information before submitting</p>
// //             </div>
...
// //                   <span className="text-black block mb-2 flex items-center gap-2">
...
// //                   <div>
// //                     <span className="text-black block mb-1 flex items-center gap-2">
// //                       <Mail size={14} /> Email
// //                     </span>
...
// //                       <div className="text-xs text-black">{formData.paymentDate}</div>
// //                     </div>
...
// //         {/* <div className="mt-8 text-center text-xs text-black flex items-center justify-center gap-4">
...
//                         <p className="text-xs text-black mt-1">Screenshot, PDF, or Image (Max 5MB)</p>
//                       </>
//                     )}
//                   </div>
//                 </div>
...
//                           {fee.amount}
//                         </div>
//                         <div className="text-xs text-black">{fee.label}</div>
//                       </div>
//                     )}
//                   </div>
  ...
  const checkAuth = async () => {
    try {
      ...
      if (regRes.ok) {
        const regData = await regRes.json();
        if (regData.hasRegistration) {
          // Redirect to dashboard if registration exists
          router.push('/dashboard');
          return;
        }
      }
  ...
  const renderAuthorCard = (index: number) => {
    ...
    return (
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-black uppercase tracking-wider flex items-center gap-1">
              <GraduationCap size={12} />
              Designation {isPrimary && <span className="text-red-500">*</span>}
            </label>
            <input
