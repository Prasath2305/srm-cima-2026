...
export default function DashboardPage() {
  ...
  if (!filePath) return;
  window.open(`/api/user/view-document?path=${encodeURIComponent(filePath)}`, '_blank');
};

const handleFullPaperUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      {!registration.full_paper_path ? (
        <div className="space-y-4">
          <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex items-start gap-3">
            ...
            <div>
              <h4 className="font-medium text-green-900 mb-1">Congratulations! Your abstract has been approved</h4>
              <p className="text-sm text-green-800">
                Please upload your full paper (PDF format, max 10MB). Ensure it follows the conference formatting guidelines.
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
              {uploadingPaper ? (
                <>
                  ...
                  <p className="text-sm text-purple-900 font-medium">Uploading...</p>
                </>
              ) : (
                <>
                  <Upload className="text-purple-600 mb-3" size={32} />
                  <p className="text-sm text-purple-900 font-medium">Click to upload Full Paper</p>
                  <p className="text-xs text-purple-600 mt-1">PDF only, max 10MB</p>
                </>
              )}
            </div>
            <input
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-green-50 border border-green-200 rounded-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-green-900">Full Paper Uploaded</p>
            ...
            <div className="flex gap-2">
              <button
                onClick={() => handleViewDocument(registration.full_paper_path!)}
