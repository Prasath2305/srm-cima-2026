...
export default function DashboardPage() {
  ...
  const [downloading, setDownloading] = useState<"abstract" | "payment" | null>(
    null,
  );
  ...
  const handleViewDocument = (filePath: string) => {
    if (!filePath) return;
    window.open(
      `/api/user/view-document?path=${encodeURIComponent(filePath)}`,
      "_blank",
    );
  };

  const handleFullPaperUpload = async (
    ...
    try {
      ...
      const res = await fetch("/api/user/upload-full-paper", {
        method: "POST",
        body: formData,
      });
      ...
      alert("Full paper uploaded successfully!");
    } catch (error: any) {
  ...
  const handleDownload = async (
    ...
    try {
      const response = await fetch(
        `/api/download?path=${encodeURIComponent(filePath)}&type=${type}`,
      );
      ...
      <div className="min-h-screen bg-[#EFEFE8] py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <h2 className="text-2xl font-light text-[#1E2A2A] mb-4">
              No Registration Found
            </h2>
            <p className="text-[#607274] mb-8 max-w-md mx-auto">
              You haven't submitted a registration for CIMA'26 yet. Complete
              your registration to participate in the conference.
            </p>
            <Link
              href="/register"
  ...
  return (
    <div className="min-h-screen bg-[#EFEFE8] py-12 px-4">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        {/* Full Paper Upload Section - Only for Approved Status */}
        {registration.status === "approved" && (
          ...
          >
            <div className="bg-[#1E2A2A] text-white px-6 py-4 flex items-center gap-2">
              <FileUp size={20} />
              <h3 className="font-medium">Full Paper Submission</h3>
              {registration.full_paper_path && (
                <CheckCircle size={18} className="ml-auto text-white/80" />
              )}
            </div>
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-800">
                        Please upload your full paper (PDF format, max 10MB).
                        Ensure it follows the conference formatting guidelines.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-green-50 border border-green-200 rounded-xl">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-green-700">
                          {registration.full_paper_path.split("/").pop()}
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-2">
                      <button
                        onClick={() =>
                          handleViewDocument(registration.full_paper_path!)
                        }
                  ...
                  <div className="border-t border-[#E5E7EB] pt-4">
                    <p className="text-sm text-[#607274] mb-3">
                      Need to update your paper? Upload a new version:
                    </p>
                    <label className="flex items-center gap-2 px-4 py-3 bg-purple-50 text-purple-700 rounded-lg cursor-pointer hover:bg-purple-100 transition-colors w-fit">
                      <Upload size={18} />
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <p className="text-lg font-medium text-[#1E2A2A]">
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-[#E5E7EB]">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-mono text-[#607274]">
                      {`CIMA260${registration.paper_id?.toString().padStart(3, "0")}`}
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between p-3 bg-[#FAFAF8] rounded-xl border border-[#E5E7EB] group hover:border-[#607274] transition-colors">
                      ...
                      <button
                        onClick={() =>
                          handleDownload(
                            registration.abstract_file_path,
                            "abstract",
                          )
                        }
                  ...
                  <div key={index} className="p-6 flex items-start gap-4">
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${
                        author.isPrimary
                          ? "bg-[#1E2A2A] text-[#FAFAF8]"
                          : "bg-[#EFEFE8] text-[#607274]"
                      }`}
                    >
                      <User size={20} />
                    </div>
            ...
            >
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm font-mono text-black bg-[#FAFAF8] px-3 py-2 rounded-lg border border-[#E5E7EB]">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#1E2A2A]">
                    {new Date(registration.payment_date).toLocaleDateString(
                      "en-US",
                      {
                        weekday: "long",
                        year: "numeric",
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#1E2A2A] break-all">
                      {registration.author_email}
                    </p>
                  </div>
                </div>
